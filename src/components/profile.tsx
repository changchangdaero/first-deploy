    ...
    <section className="flex flex-col sm:flex-row items-center gap-8 w-full">
      ...
      <div className="text-center sm:text-left">
        ...
        <div className="flex flex-wrap gap-4 justify-center sm:justify-start text-sm text-green-200/70">
          <a className="hover:text-white underline underline-offset-4" href="https://search.naver.com/search.naver?where=nexearch&sm=tab_etc&mra=bjky&pkid=1&os=35402807&qvt=0&query=%EC%9C%A0%EC%B0%BC%EB%AF%BC" target="_blank" rel="noopener noreferrer">Profile</a>
