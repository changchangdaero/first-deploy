  ...
  return (
    <section className="flex flex-col sm:flex-row items-center gap-8 w-full">
      ...
      <div className="text-center sm:text-left">
        ...
        <p className="text-green-400 font-medium mb-4 text-lg italic font-sans">
        ...
        <div className="flex flex-wrap gap-4 justify-center sm:justify-start text-sm text-green-200/70">
          ...
          <a className="hover:text-white underline underline-offset-4" href={blogUrl} target="_blank" rel="noopener noreferrer">Blog</a>
